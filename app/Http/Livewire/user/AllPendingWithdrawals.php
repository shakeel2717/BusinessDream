...
final class AllPendingWithdrawals extends PowerGridComponent
{
    use ActionButton;
    ...
    */
    ...
    {
        return Transaction::query()->where('user_id', auth()->user()->id)->where('type', 'withdraw')->where('status', false);
    }
